...
inline void Raylib::File::unloadFileData(std::string data)
{
    return ::UnloadFileData((unsigned char *) data.c_str());
}

inline bool Raylib::File::saveFileData(const std::string fileName, void *data, unsigned int bytesToWrite)
{
...
void Raylib::File::unloadFileText(std::string text)
{
    return ::UnloadFileText(const_cast<char *>(text.c_str()));
}

bool Raylib::File::saveFileText(const std::string fileName, std::string text)
{
    return ::SaveFileText(fileName.c_str(), const_cast<char *>(text.c_str()));
}

bool Raylib::File::fileExists(const std::string fileName)
{
    return ::FileExists(fileName.c_str());
}

bool Raylib::File::directoryExists(const std::string dirPath)
{
    return ::DirectoryExists(dirPath.c_str());
}

bool Raylib::File::isFileExtension(const std::string fileName, const std::string ext)
{
    return ::IsFileExtension(fileName.c_str(), ext.c_str());
}

const std::string Raylib::File::getFileExtension(const std::string fileName)
{
    return ::GetFileExtension(fileName.c_str());
}

const std::string Raylib::File::getFileName(const std::string filePath)
{
    return ::GetFileName(filePath.c_str());
}
const std::string Raylib::File::getFileNameWithoutExt(const std::string filePath)
{
    return ::GetFileNameWithoutExt(filePath.c_str());
}
const std::string Raylib::File::getDirectoryPath(const std::string filePath)
{
    return ::GetDirectoryPath(filePath.c_str());
}
const std::string Raylib::File::getPrevDirectoryPath(const std::string dirPath)
{
    return ::GetPrevDirectoryPath(dirPath.c_str());
}
const std::string Raylib::File::getWorkingDirectory(void)
{
...
bool Raylib::File::changeDirectory(const std::string dir)
{
    return ::ChangeDirectory(dir.c_str());
}

bool Raylib::File::isFileDropped(void)
{
