...
*/
    ...
    inline std::string Raylib::File::loadFileData(const std::string &fileName,
    ...
    inline bool
    Raylib::File::saveFileData(const std::string &fileName, void *data,
    ...
    inline bool Raylib::File::saveFileText(const std::string &fileName,
                                           const std::string &text) {
        return ::SaveFileText(fileName.c_str(),
    ...
    inline bool Raylib::File::isFileExtension(const std::string &fileName,
                                              const std::string &ext) {
        return ::IsFileExtension(fileName.c_str(), ext.c_str());
    }

    inline const std::string
    Raylib::File::getFileExtension(const std::string &fileName) {
        return ::GetFileExtension(fileName.c_str());
    }

    inline const std::string
    Raylib::File::getFileName(const std::string &filePath) {
        return ::GetFileName(filePath.c_str());
    }

    inline const std::string
    Raylib::File::getFileNameWithoutExt(const std::string &filePath) {
        return ::GetFileNameWithoutExt(filePath.c_str());
    }

    inline const std::string
    Raylib::File::getDirectoryPath(const std::string &filePath) {
        return ::GetDirectoryPath(filePath.c_str());
    }

    inline const std::string
    Raylib::File::getPrevDirectoryPath(const std::string &dirPath) {
    ...
    Raylib::File::getDirectoryFiles(const std::string &dirPath, int &count)
