    ...
    class Camera3D {
        public:
           ...
           /**
             ...
             */
            Ray getMouseRay(::Vector2 const &mousePosition, Camera3D const &camera) const;
           ...
           /**
             ...
             */
            void drawBillboard(Camera3D const &camera, Texture2D const &texture, Vector3 const &center, float const &size, Raylib::Color const &tint) const;
             ...
             * @param tint A Color Class
             */
            void drawBillboardRec(Camera3D const &camera, Texture2D const &texture, Rectangle const &source, Vector3 const &center, Vector2 const &size, Raylib::Color const &tint) const;
